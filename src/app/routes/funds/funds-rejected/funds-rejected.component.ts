...
@Component({
  selector: 'app-funds-rejected',
  templateUrl: './funds-rejected.component.html',
  styleUrls: ['./funds-rejected.component.less']
})
export class FundsRejectedComponent implements OnInit {
  orderId: any = '';
  info: any = {};
