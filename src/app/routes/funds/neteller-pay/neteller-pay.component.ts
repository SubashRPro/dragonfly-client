...
@Component({
  selector: 'app-neteller-pay',
  templateUrl: './neteller-pay.component.html',
  styles: []
})
export class NetellerPayComponent implements OnInit {
  kycMessage!:boolean
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(param => {
      console.log(param)
      this.param = { ...param };
      this.http.netterlerDeposit({ ...this.param, postType: undefined }).subscribe((res:any)=> {
